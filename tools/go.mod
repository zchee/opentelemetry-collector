...
replace github.com/open-telemetry/opentelemetry-collector-builder => github.com/fangyi-zhou/opentelemetry-collector-builder v0.23.1-0.20210616062143-d6406b0a3ef7
